...
Twilio.Device.connect(function (connection) {
	...
	//if phoneNumber is not part of the connection, this is a call from a
...
Twilio.Device.disconnect(function(conenction) {
...
/* Callback for when Twilio receives a new incoming call */
