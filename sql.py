...
addLead('2', 'Pedro Bahaghari', '09324567890', 'pedrobahaghari@gmail.com', 'Is your refrigerator running?')
addLead('2', 'Marco Buttondown', '09321112233', 'marcobuttons@hotmail.com', 'Where is Marco Polo located?')
addLead('2', 'Juan Tamad', '09324445567', 'juantamad@yahoo.com', 'When will the guava fall from that tree?')
connection.commit()
#connection.close()